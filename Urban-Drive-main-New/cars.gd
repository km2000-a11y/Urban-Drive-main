...
var car_prices := {
	...
	# SPORT (100k–160k)
	"Eisenach Goblin": 135000,     # ↓ slightly
	"Schroder Classique Sport": 115000,  # ↓ slightly
	"Brutus Stingray": 125000,     # ↓ slightly
	"Berkshire V12-S": 150000,     # ↓ slightly
	"Berkshire Tempest": 160000,   # ↓ slightly
	"Kestrel Touring": 145000,     # ↓ slightly

	# SPORT RACING (180k–260k)
...
var money: int = 0
var save_path := "user://player_money.save"
